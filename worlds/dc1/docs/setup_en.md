# Dark Cloud 1 Setup Guide

## Required Software
- Windows only for now
- [Archipelago](https://archipelago.gg/tutorial/Archipelago/setup_en) 0.6.7 or later
- PCSX2 1.7+  (2.6+ recommended)
- Legally obtained NTSC copy of Dark Cloud 1
...
- Start the client
- Click the burger icon in the client, put in host/slot/password info and click connect. Make sure to connect before
entering a dungeon!

## Things of note
- Save states are not 100% supported yet. If you want to use them, reset the game before loading the state.  Certain things might not be acknowledged correctly otherwise.

...
r_fish_shops1 = Or(And(CanReachRegion("Matataki"), r_owl),
                   And(CanReachRegion("Queens"), Or(r_ruty, r_lana)))
r_fish_shops2 = Or(And(CanReachRegion("Muska"), r_brooke), r_fish_shops1)
...
# Oasis
r_desert_fish = And(r_rod, Has("Oasis"), r_fish_shops2)
r_niler_fish = And(r_rod, r_norune_pond, r_fish_shops2)
r_gummy_fish = And(r_rod, Or(r_norune_pond, CanReachRegion("Matataki")), r_fish_shops1)
r_nonky_fish = And(r_rod, Or(r_norune_pond, CanReachRegion("Matataki")), r_fish_shops2)
r_gobbler_fish = And(r_rod,
                     Or(r_norune_pond, And(r_peanut_pond, CanReachRegion("Matataki"))),
                     r_fish_shops1)
r_baku_fish = And(r_rod, r_fish_shops1)
r_tarton_fish = And(r_rod, r_peanut_pond, r_fish_shops2)
...
# Oasis
r_desert_fish_ut = And(r_rod, Has("Oasis"), Or(r_fish_shops2, Has(glitch_name)))
r_niler_fish_ut = And(r_rod, r_norune_pond, Or(r_fish_shops2, Has(glitch_name)))
r_gummy_fish_ut = And(r_rod, Or(r_norune_pond, CanReachRegion("Matataki")), Or(r_fish_shops1, Has(glitch_name)))
r_nonky_fish_ut = And(r_rod, Or(r_norune_pond, CanReachRegion("Matataki")), Or(r_fish_shops2, Has(glitch_name)))
r_gobbler_fish_ut = And(r_rod,
                     Or(r_norune_pond, And(r_peanut_pond, CanReachRegion("Matataki"))),
                     Or(r_fish_shops1, Has(glitch_name)))
r_baku_fish_ut = And(r_rod, Or(r_fish_shops1, Has(glitch_name)))
r_tarton_fish_ut = And(r_rod, r_peanut_pond, Or(r_fish_shops2, Has(glitch_name)))
# Client adds carrots to owl shop
